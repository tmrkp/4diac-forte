...
const CStringDictionary::TStringId FORTE_HMILightIndicator::scmDataInputNames[] = {
    STRID(QI), STRID(LABEL), STRID(BoolOutput)};
...
const TDataIOID FORTE_HMILightIndicator::scmEOWith[] = {0, 1, scmWithListDelimiter};
const TForteInt16 FORTE_HMILightIndicator::scmEOWithIndexes[] = {0, -1};
