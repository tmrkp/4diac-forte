...
const CStringDictionary::TStringId FORTE_HMICheckBox::scmDataInputNames[] = {STRID(QI), STRID(Label), STRID(WidgetName),
                                                                             STRID(BooleanInput)};
const CStringDictionary::TStringId FORTE_HMICheckBox::scmDataInputTypeIds[] = {STRID(BOOL), STRID(STRING),
...
const TDataIOID FORTE_HMICheckBox::scmEIWith[] = {0, 1, 2, 3, scmWithListDelimiter};
