...
class FORTE_HMIChart final : public IOConfigFBMultiSlave {
    DECLARE_FIRMWARE_FB(FORTE_HMIChart)

  public:
    FORTE_HMIChart(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_HMIChart() override = default;
