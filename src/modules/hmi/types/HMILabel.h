...
class FORTE_HMILabel final : public IOConfigFBMultiSlave {
  ...
  public:
    ...
    CDataConnection *conn_DoubleOutput;
    ...
    void evt_MAP(const CIEC_BOOL &paQI,
                 ...
                 const CIEC_STRING &paDoubleOutput,
                 CIEC_BOOL &paQO,
                 CIEC_WSTRING &paSTATUS) {
      var_QI = paQI;
      var_WidgetName = paWidgetName;
      var_DoubleOutput = paDoubleOutput;
    ...
    void operator()(const CIEC_BOOL &paQI,
                    ...
                    CIEC_BOOL &paQO,
                    CIEC_WSTRING &paSTATUS) {
      evt_MAP(paQI, paWidgetName, paDoubleOutput, paQO, paSTATUS);
    }
