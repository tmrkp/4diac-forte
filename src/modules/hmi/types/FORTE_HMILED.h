...
class FORTE_HMILED final : public IOConfigFBMultiSlave {
    DECLARE_FIRMWARE_FB(FORTE_HMILED)

  public:
    FORTE_HMILED(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_HMILED() override = default;
