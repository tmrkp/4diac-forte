...
class FORTE_HMIBusAdapter : public IOConfigFBMultiAdapter {
    DECLARE_ADAPTER_TYPE(FORTE_HMIBusAdapter)

  public:
    ADAPTER_CTOR_FOR_IO_MULTI(FORTE_HMIBusAdapter) {
    }

    virtual ~FORTE_HMIBusAdapter() {
    }
