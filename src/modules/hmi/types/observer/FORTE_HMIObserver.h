...
class FORTE_HMIObserver final : public IOConfigFBMultiSlave {
    DECLARE_FIRMWARE_FB(FORTE_HMIObserver)

  public:
    FORTE_HMIObserver(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_HMIObserver() override = default;
