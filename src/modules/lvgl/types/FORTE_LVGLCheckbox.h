...
class FORTE_LVGLCheckbox final : public IOConfigFBMultiSlave {
    DECLARE_FIRMWARE_FB(FORTE_LVGLCheckbox)

  public:
    FORTE_LVGLCheckbox(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_LVGLCheckbox() override = default;
