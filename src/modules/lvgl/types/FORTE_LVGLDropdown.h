...
class FORTE_LVGLDropdown final : public IOConfigFBMultiSlave {
    DECLARE_FIRMWARE_FB(FORTE_LVGLDropdown)

  public:
    FORTE_LVGLDropdown(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_LVGLDropdown() override = default;
