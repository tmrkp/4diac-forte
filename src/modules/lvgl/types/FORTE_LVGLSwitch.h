...
class FORTE_LVGLSwitch final : public IOConfigFBMultiSlave {
    DECLARE_FIRMWARE_FB(FORTE_LVGLSwitch)

  public:
    FORTE_LVGLSwitch(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_LVGLSwitch() override = default;
