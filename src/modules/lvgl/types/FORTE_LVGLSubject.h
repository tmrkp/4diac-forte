...
class FORTE_LVGLSubject final : public IOConfigFBMultiSlave {
    DECLARE_FIRMWARE_FB(FORTE_LVGLSubject)

  public:
    FORTE_LVGLSubject(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_LVGLSubject() override = default;
