...
class FORTE_LVGLLED final : public IOConfigFBMultiSlave {
    DECLARE_FIRMWARE_FB(FORTE_LVGLLED)

  public:
    FORTE_LVGLLED(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_LVGLLED() override = default;

    CIEC_BOOL var_QI;
    CIEC_STRING var_Label;
    CIEC_STRING var_WidgetName;
    CIEC_STRING var_BooleanOutput;
    CIEC_STRING var_ByteOutput;
    ...
    CDataConnection *conn_BooleanOutput;
    CDataConnection *conn_ByteOutput;
    ...
    void evt_MAP(const CIEC_BOOL &paQI,
                 ...
                 const CIEC_STRING &paBooleanOutput,
                 const CIEC_STRING &paByteOutput,
                 CIEC_BOOL &paQO,
                 CIEC_WSTRING &paSTATUS) {
      var_QI = paQI;
      var_Label = paLabel;
      var_WidgetName = paWidgetName;
      var_BooleanOutput = paBooleanOutput;
      var_ByteOutput = paByteOutput;
    ...
    void operator()(const CIEC_BOOL &paQI,
                    ...
                    CIEC_BOOL &paQO,
                    CIEC_WSTRING &paSTATUS) {
      evt_MAP(paQI, paLabel, paWidgetName, paBooleanOutput, paByteOutput, paQO, paSTATUS);
    }
