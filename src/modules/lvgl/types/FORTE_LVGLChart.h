...
class FORTE_LVGLChart final : public IOConfigFBMultiSlave {
    DECLARE_FIRMWARE_FB(FORTE_LVGLChart)

  public:
    FORTE_LVGLChart(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_LVGLChart() override = default;
