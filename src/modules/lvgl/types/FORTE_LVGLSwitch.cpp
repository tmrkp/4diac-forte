...
const TDataIOID FORTE_LVGLSwitch::scmEOWith[] = {0, scmWithListDelimiter, 0, 1, scmWithListDelimiter};
const TForteInt16 FORTE_LVGLSwitch::scmEOWithIndexes[] = {0, 2};
const CStringDictionary::TStringId FORTE_LVGLSwitch::scmEventOutputNames[] = {STRID(MAPO), STRID(IND)};
const CStringDictionary::TStringId FORTE_LVGLSwitch::scmEventOutputTypeIds[] = {STRID(Event), STRID(Event)};
const SAdapterInstanceDef FORTE_LVGLSwitch::scmAdapterInstances[] = {
    {STRID(LVGLBusAdapter), STRID(BusAdapterOut), true},
    {STRID(LVGLBusAdapter), STRID(BusAdapterIn), false},
};
const SFBInterfaceSpec FORTE_LVGLSwitch::scmFBInterfaceSpec = {
    1,
...
const TForteUInt8 FORTE_LVGLSwitch::scmSlaveConfigurationIO[] = {};
const TForteUInt8 FORTE_LVGLSwitch::scmSlaveConfigurationIONum = 0;

FORTE_LVGLSwitch::FORTE_LVGLSwitch(const CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer) :
...
void FORTE_LVGLSwitch::setInitialValues() {
  var_QI = 0_BOOL;
  var_Label = ""_STRING;
  var_WidgetName = ""_STRING;
  var_BooleanInput = ""_STRING;
...
void FORTE_LVGLSwitch::readInputData(const TEventID paEIID) {
  switch (paEIID) {
    case scmEventMAPID: {
...
void FORTE_LVGLSwitch::writeOutputData(const TEventID paEIID) {
  switch (paEIID) {
    case scmEventMAPOID: {
...
CIEC_ANY *FORTE_LVGLSwitch::getDI(const size_t paIndex) {
  switch (paIndex) {
...
CIEC_ANY *FORTE_LVGLSwitch::getDO(const size_t paIndex) {
  switch (paIndex) {
...
CEventConnection *FORTE_LVGLSwitch::getEOConUnchecked(const TPortId paIndex) {
  switch (paIndex) {
...
CDataConnection **FORTE_LVGLSwitch::getDIConUnchecked(const TPortId paIndex) {
  switch (paIndex) {
...
CDataConnection *FORTE_LVGLSwitch::getDOConUnchecked(const TPortId paIndex) {
  switch (paIndex) {
...
void FORTE_LVGLSwitch::initHandles() {
