...
class FORTE_LVGLSlider final : public IOConfigFBMultiSlave {
    DECLARE_FIRMWARE_FB(FORTE_LVGLSlider)

  public:
    FORTE_LVGLSlider(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_LVGLSlider() override = default;
