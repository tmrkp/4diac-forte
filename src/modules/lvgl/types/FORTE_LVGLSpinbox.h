...
class FORTE_LVGLSpinbox final : public IOConfigFBMultiSlave {
    DECLARE_FIRMWARE_FB(FORTE_LVGLSpinbox)

  public:
    FORTE_LVGLSpinbox(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_LVGLSpinbox() override = default;
