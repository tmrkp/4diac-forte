...
class FORTE_LVGLNumber final : public IOConfigFBMultiSlave {
    DECLARE_FIRMWARE_FB(FORTE_LVGLNumber)

  public:
    FORTE_LVGLNumber(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_LVGLNumber() override = default;
