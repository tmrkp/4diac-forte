...
class FORTE_LVGLMaster : IOConfigFBMultiMaster {
    DECLARE_FIRMWARE_FB(FORTE_LVGLMaster)

  public:
    FORTE_LVGLMaster(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_LVGLMaster() override = default;
    ...
    FORTE_LVGLBusAdapter &var_BusAdapterOut() {
      return *static_cast<FORTE_LVGLBusAdapter *>(mAdapters[0]);
    };
