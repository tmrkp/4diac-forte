...
class FORTE_LVGLProgressbar final : public IOConfigFBMultiSlave {
    DECLARE_FIRMWARE_FB(FORTE_LVGLProgressbar)

  public:
    FORTE_LVGLProgressbar(CStringDictionary::TStringId paInstanceNameId, CFBContainer &paContainer);
    ~FORTE_LVGLProgressbar() override = default;
